...
def  PowerVoltageGraph(source,days,delay):
	...
	try:
		...
		pylab.figtext(.5, .05, ("SkyWeather Power Voltage Last %i Days" % days),fontsize=18,ha='center')
		pyplot.setp( ax.xaxis.get_majorticklabels(), rotation=70)

		pylab.grid(True)

		pyplot.show()
		pyplot.savefig("/home/pi/SDL_Pi_SkyWeather/static/PowerVoltageGraph.png",facecolor=fig.get_facecolor())	
